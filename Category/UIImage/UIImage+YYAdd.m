...
- (UIImage *)imageByBlurSoftRadius:(CGFloat)radius {
    return [self imageByBlurRadius:radius tintColor:[UIColor colorWithWhite:0.84 alpha:0.36] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}
