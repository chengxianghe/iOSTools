...
- (BOOL)containsEmoji {
    return [self containsEmojiForSystemVersion:[self.class systemVersion]];
}
...
#pragma mark - add by cxh

- (NSAttributedString *)attributedStringWithLineHeightMultiple:(CGFloat)lineHeightMultiple font:(UIFont *)font {
    NSMutableDictionary *attr = [NSMutableDictionary new];
    attr[NSFontAttributeName] = font;
